...
namespace Auctions.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public ListingsController(IListingsService listingsService, ICommentService commentService, IBidsService bidsService, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> MyBids(int? pageNumber)
        {
            ...
            return View("Index", await PaginatedList<Bid>.CreateAsync(applicationDbContext.Where(l => l.IdentityUserId == User.FindFirstValue(ClaimTypes.NameIdentifier)).AsNoTracking(), pageNumber ?? 1, pageSize));
        }
